...
export default function Player({player, deletePlayer, toggleEditPlayer}){
    ...
    return (
        <>
            <li className="flex justify-center space-x-3 m-1">
                <span className="text-lg">{`${player.fullName} ${teamText}`}</span>
                <svg onClick={() => toggleEditPlayer(player.id)} xmlns="http://www.w3.org/2000/svg" width="20" height="20" viewBox="0 0 24 24" className="mt-1">
                ...
                <svg onClick={() => deletePlayer(player.id)} xmlns="http://www.w3.org/2000/svg" width="16" height="16" viewBox="0 0 24 24" className="mt-1.5">
